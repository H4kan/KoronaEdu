...
function get_message(){
	var nowa = document.getElementById("message").value;
	return nowa; 
}
...
function send_message(message){
	...
	for (var i = 0; i < messages.length; i++) {
		...
		document.querySelector(".message"+i).innerHTML = messages[messages.length-i-1];
	
	}

	var pole = document.getElementById("message");
	pole.value="";
